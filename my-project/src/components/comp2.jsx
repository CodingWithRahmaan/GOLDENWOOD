    ...
    <section className="w-full bg-white rounded-t-4xl relative z-100">
      <div
        className="
          ...
          gap-12
          px-4 sm:px-6
          pt-20 sm:pt-28 md:pt-36 lg:pt-50
          pb-20 sm:pb-28 md:pb-36 lg:pb-50
        "
      >
        {/* LEFT IMAGE AREA */}
        <div className="relative flex justify-center">
          ...
          <img
            ...
            className="
              w-full
              h-[300px] sm:h-[400px] md:h-[450px] lg:h-[600px]
              object-cover
              rounded-lg
            "
          />

          {/* Overlapping Image — ONLY DESKTOP */}
          <img
            src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?fm=jpg&q=60&w=3000"
            alt="Overlap"
            className="
              hidden lg:block
              absolute -bottom-7 left-28 xl:left-110
              w-[180px] h-[160px]
              xl:w-[250px] xl:h-[230px]
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed mt-4 mb-6 text-sm sm:text-base max-w-xl lg:max-w-none">
            Established in 2013, Golden Woods Development has the power to transform
            lives and redefine the essence of modern living.
            <br />
            <br />
            With every project, Golden Woods Development aims to deliver more than
            buildings—we deliver dreams.
          </p>
